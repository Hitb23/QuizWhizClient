...
const CardComponent = ({ count, text, icon , active ,onClickHandler }) => {
  ...
  return (
    <div className={`col-lg-3 mb-4 col-sm-6 col-6`}>
        <div className={`${classes["total-category"]} card-body text-center rounded-2 p-3 ${text.toLowerCase()===active ? classes['total-category-active']: ''}`} onClick={()=> onClickHandler(text.toLowerCase())}>
