...
const ViewQuizQuestions = ({ currentQuizLink }) => {
          ...
          then: () =>
            Yup.array()
              ...
              .test(
                ...
                (options) => {
                  const optionTexts = options.map((option) => option.OptionText);
  ...
  const addNewQuestion = () => {
    ...
    updatedQuestions[newQuestionIndex].questionType === 3;
    ...
    formik.setTouched({
      ...
      Questions: {
        ...
        [newQuestionIndex]: {
          question: false,
          Options: isTrueFalseQuestion
            ? []
            : updatedQuestions[newQuestionIndex].Options.map(
                () => false
              ),
          Answers: false,
        },
