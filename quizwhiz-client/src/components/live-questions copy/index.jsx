...
import { FiftyPY, HeartPY, Skip, SkipPY } from "../../assets";
import { Tooltip } from "@mui/material";
const LiveQuestionsCopy = ({
    ...
    <main className={`${classes["live-questions-div"]} row row-gap-1`}>
      ...
      >
          ...
          >
            ...
            <div className={`${classes['coin-box']} rounded-4 shadow`} style={{padding:'10px',border:'1px solid yellow'}} >
              <img
                src={SkipPY}
                height={50}
              />
            ...
            <Tooltip title="50-50">
            <div className={`${classes['coin-box']} rounded-4 shadow`} style={{padding:'4px' ,border:'1px solid yellow'}} >
              <img
                src={FiftyPY}
                height={60}
              />
      ...
      {/* <div className="d-flex justify-content-center align-items-around row-gap-4 row m-0 column-gap-4 col-md-8 col-sm-10 col-11 p-0">
        <div className="d-flex justify-content-start align-items-start row row-gap-5 p-0 col-11">
          <div className={`${classes["questionText"]}`}>fdfdsaf</div>
        </div>
...
export default LiveQuestionsCopy;
